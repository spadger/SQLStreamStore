namespace SqlStreamStore
{
    ...
    public class StreamStoreSettings
    {
        ...
        ///     creates <see cref="PollingBasedStoreNotifier"/>
        /// </summary>
        public CreateStoreUpdatedNotifier CreateStoreUpdatedNotifier { get; set; } =
            store => new PollingBasedStoreNotifier(store);
        ...
        {
            get => _getUtcNow ?? SystemClock.GetUtcNow;
        ...
        /// </summary>
        public string LogName { get; protected set; } = "SqlStreamStore";
    }
}